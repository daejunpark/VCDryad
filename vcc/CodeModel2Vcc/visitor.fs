...
namespace Microsoft.Research.Vcc
  ...
  module StringLiterals =
    ...
    [<Literal>]
    let SystemDiagnosticsContractsCodeContractIntset = "System.Diagnostics.Contracts.CodeContract.Intset"

    [<Literal>]
    let SystemDiagnosticsContractsCodeContractOset = "System.Diagnostics.Contracts.CodeContract.Oset"
            ...
            | PrimitiveTypeCode.NotPrimitive ->
              ...
              if hasit then C.Type.Ref (ret)
                ...
                if name.StartsWith mathPref && datatypeDefinition = null && not isMathRecord then
                  ...
                  C.Type.Math "\\objset"
                else if name = SystemDiagnosticsContractsCodeContractIntset then
                  C.Type.Math "\\intset"
                else if name = SystemDiagnosticsContractsCodeContractOset then
                  C.Type.Math "\\oset"
                else              
