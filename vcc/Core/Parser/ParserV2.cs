    ...
    override protected bool TryToGetBuiltInSpecTypeName(TypedefNameSpecifier typedefName, out TypeExpression result) {
      switch (typedefName.TypedefName.ToString()) {
        ...
        case "\\objset":
          ...
          return true;
        case "\\intset":
          Expression intsetRef = NamespaceHelper.CreateInSystemDiagnosticsContractsCodeContractExpr(this.nameTable, "Intset");
          result = new VccNamedTypeExpression(intsetRef);
          return true;
        case "\\oset":
          Expression osetRef = NamespaceHelper.CreateInSystemDiagnosticsContractsCodeContractExpr(this.nameTable, "Oset");
          result = new VccNamedTypeExpression(osetRef);
          return true;
        default:
          result = null;
          return false;
