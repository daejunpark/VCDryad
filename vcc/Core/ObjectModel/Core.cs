...
namespace Microsoft.Research.Vcc {
  ...
  public sealed class VccCompilationHelper : LanguageSpecificCompilationHelper {
    ...
    public static readonly string SystemDiagnosticsContractsCodeContractIntsetString = Microsoft.Cci.Ast.NamespaceHelper.SystemDiagnosticsContractsCodeContractString + ".Intset";
    public static readonly string SystemDiagnosticsContractsCodeContractOsetString = Microsoft.Cci.Ast.NamespaceHelper.SystemDiagnosticsContractsCodeContractString + ".Oset";
      ...
      switch (typeDefinition.TypeCode)
      {
        ...
        default:
          ...
          if (TypeHelper.GetTypeName(typeDefinition) == SystemDiagnosticsContractsCodeContractTypedPtrString)
            ...
            return "\\objset";
          else if (TypeHelper.GetTypeName(typeDefinition) == SystemDiagnosticsContractsCodeContractIntsetString)
              return "\\intset";
          else if (TypeHelper.GetTypeName(typeDefinition) == SystemDiagnosticsContractsCodeContractOsetString)
              return "\\oset";
          else
