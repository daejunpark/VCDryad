...
namespace Microsoft.Research.Vcc
{
  ...
  class VccFunctionVerifier : FunctionVerifier
  {
    ...
    readonly string[] standardBoogieOptions = new[] { 
      ...
      //"/z3opt:RELEVANCY=2",
      //"/z3opt:RELEVANCY_LEMMA=true",
      
      /* comment for bvd
      "/z3opt:MBQI=true",
      "/z3opt:MBQI_FORCE_TEMPLATE=5",
      "/z3opt:MBQI_MAX_CEXS=5",
      "/z3opt:MBQI_MAX_CEXS_INCR=5",
      "/z3opt:MBQI_MAX_ITERATIONS=100",
      //*/
      
      /* comment for bvd
      "/z3opt:ARRAY_ALWAYS_PROP_UPWARD=true",
      "/z3opt:ARRAY_CANONIZE=false",    
      "/z3opt:ARRAY_CG=true",
      "/z3opt:ARRAY_DELAY_EXP_AXIOM=false",
      "/z3opt:ARRAY_EXTENSIONAL=true",
      "/z3opt:ARRAY_LAZINESS=1",
      "/z3opt:ARRAY_LAZY_IEQ=true",
      "/z3opt:ARRAY_LAZY_IEQ_DELAY=10",
      "/z3opt:ARRAY_SOLVER=3",
      "/z3opt:ARRAY_WEAK=false",
      //*/

      /* comment for bvd
      "/z3opt:CNF_MODE=2",
      "/z3opt:MODEL_COMPACT=true",
      // */
      //"/z3opt:RESTART_STRATEGY=3",

      "/z3opt:/memory:1600",
      "/z3opt:CASE_SPLIT=5",
      //"/z3opt:PULL_NESTED_QUANTIFIERS=true",

      //* uncomment for BVD
      "/z3opt:QI_QUICK_CHECKER=2",
      "/z3opt:QI_EAGER_THRESHOLD=100",     
      //*/

      /* comment for BVD
      "/z3opt:QI_EAGER_THRESHOLD=5",     
      "/z3opt:QI_LAZY_INSTANTIATION=true",
      "/z3opt:QI_LAZY_THRESHOLD=20",
      "/z3opt:QI_PROMOTE_UNSAT=true",
      "/z3opt:QI_MAX_LAZY_MULTI_PATTERN_MATCHING=2",
      "/z3opt:QI_LAZY_QUICK_CHECKER=true"
       /* */
    };
