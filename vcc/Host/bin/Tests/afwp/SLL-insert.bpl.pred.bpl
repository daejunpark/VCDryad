...
invariant b0009 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && F#srtl($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0010 ==> (((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) && F#srtl($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0011 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && F#srtl($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0012 ==> (((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) && F#srtl($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0013 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && F#srtl($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0014 ==> (((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) && F#srtl($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0015 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#srtl($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0016 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#srtl($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0017 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#srtl($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0018 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#srtl($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0019 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#srtl($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0020 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#srtl($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0021 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#srtl($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0022 ==> (((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#srtl($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0023 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#srtl($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0024 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#srtl($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0025 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#srtl($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0026 ==> (((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#srtl($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0027 ==> ((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0028 ==> ((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0029 ==> ((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0030 ==> ((F#srtl($s,$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0031 ==> ((F#srtl($s,$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0032 ==> ((F#srtl($s,$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#srtl_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0033 ==> ((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0034 ==> ((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0035 ==> ((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0036 ==> ((F#srtl_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0037 ==> ((F#srtl_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0038 ==> ((F#srtl_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#srtl_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
...
invariant b0132 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) < P#v));
invariant b0133 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) < P#v));
invariant b0134 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) < P#v));
invariant b0135 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))));
invariant b0136 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))));
invariant b0137 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))));
invariant b0138 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))));
invariant b0139 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))));
invariant b0140 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))));
invariant b0141 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))));
invariant b0142 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))));
invariant b0143 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))));
invariant b0144 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))));
invariant b0145 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))));
invariant b0146 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))));
invariant b0147 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#v));
invariant b0148 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) == P#v));
invariant b0149 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#v));
invariant b0150 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) == P#v));
invariant b0151 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) == P#v));
invariant b0152 ==> ((F#sll_lseg_len_next($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) == P#v));
invariant b0153 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),$intset_singleton(P#v)));
invariant b0154 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),$intset_singleton(P#v)));
invariant b0155 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),$intset_singleton(P#v)));
invariant b0156 ==> ($intset_le($intset_singleton(P#v),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))));
invariant b0157 ==> ($intset_le($intset_singleton(P#v),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))));
invariant b0158 ==> ($intset_le($intset_singleton(P#v),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node))));
invariant b0159 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)),$intset_singleton(P#v)));
invariant b0160 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)),$intset_singleton(P#v)));
invariant b0161 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)),$intset_singleton(P#v)));
invariant b0162 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)),$intset_singleton(P#v)));
invariant b0163 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)),$intset_singleton(P#v)));
invariant b0164 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)),$intset_singleton(P#v)));
invariant b0165 ==> ($intset_le($intset_singleton(P#v),F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0166 ==> ($intset_le($intset_singleton(P#v),F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0167 ==> ($intset_le($intset_singleton(P#v),F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0168 ==> ($intset_le($intset_singleton(P#v),F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0169 ==> ($intset_le($intset_singleton(P#v),F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0170 ==> ($intset_le($intset_singleton(P#v),F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0171 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0172 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0173 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0174 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(L#j,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0175 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(P#h,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0176 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(L#i,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0177 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))),F#sll_keys($s,$phys_ptr_cast(P#h,^s_node))));
invariant b0178 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))),F#sll_keys($s,$phys_ptr_cast(L#i,^s_node))));
invariant b0179 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))),F#sll_keys($s,$phys_ptr_cast(L#j,^s_node))));
invariant b0180 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0181 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0182 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0183 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0184 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0185 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0186 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0187 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0188 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0189 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0190 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0191 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0192 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0193 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node)))));
invariant b0194 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0195 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node)))));
invariant b0196 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0197 ==> ($intset_le(F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node)))));
invariant b0198 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0199 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#h,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0200 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node))));
invariant b0201 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#i,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node))));
invariant b0202 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node))));
invariant b0203 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(L#j,^s_node))),F#sll_lseg_keys($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node))));
