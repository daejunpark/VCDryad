...
// INV:PTR: P#i, P#j, L#h, L#k, local.i, local.j
// INV:INT:
...
// INV:BEGIN
      ...
      invariant F#srtl($s, $phys_ptr_cast(L#h, ^s_node));
      invariant F#srtl($s, $phys_ptr_cast(L#k, ^s_node));
      invariant F#srtl_lseg($s, $phys_ptr_cast(L#h, ^s_node), $phys_ptr_cast(L#k, ^s_node));
      invariant $is_null($phys_ptr_cast(L#k, ^s_node)) ==> $phys_ptr_cast(L#h, ^s_node) == $phys_ptr_cast(local.i, ^s_node);
      invariant $non_null($phys_ptr_cast(L#k, ^s_node)) ==> $oset_disjoint(F#srtl_lseg_reach($s, $phys_ptr_cast(L#h, ^s_node), $phys_ptr_cast(L#k, ^s_node)), F#srtl_reach($s, $phys_ptr_cast(L#k, ^s_node)));
      invariant $non_null($phys_ptr_cast(L#k, ^s_node)) ==> $oset_disjoint(F#srtl_lseg_reach($s, $phys_ptr_cast(L#h, ^s_node), $phys_ptr_cast(L#k, ^s_node)), F#srtl_reach($s, $phys_ptr_cast(local.i, ^s_node)));
      invariant $non_null($phys_ptr_cast(L#k, ^s_node)) ==> $oset_disjoint(F#srtl_lseg_reach($s, $phys_ptr_cast(L#h, ^s_node), $phys_ptr_cast(L#k, ^s_node)), F#srtl_reach($s, $phys_ptr_cast(local.j, ^s_node)));
      invariant $non_null($phys_ptr_cast(L#k, ^s_node)) ==> !$oset_in($phys_ptr_cast(L#k, ^s_node), F#srtl_reach($s, $phys_ptr_cast(local.i, ^s_node)));
      invariant $non_null($phys_ptr_cast(L#k, ^s_node)) ==> !$oset_in($phys_ptr_cast(L#k, ^s_node), F#srtl_reach($s, $phys_ptr_cast(local.j, ^s_node)));
      invariant $non_null($phys_ptr_cast(L#k, ^s_node)) ==> $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#k, ^s_node), ^s_node) == $phys_ptr_cast(local.i, ^s_node);
      invariant F#srtl_lseg($s, $phys_ptr_cast(L#k, ^s_node), $phys_ptr_cast(local.i, ^s_node));
      invariant $oset_disjoint(F#srtl_lseg_reach($s, $phys_ptr_cast(L#k, ^s_node), $phys_ptr_cast(local.i, ^s_node)), F#srtl_reach($s, $phys_ptr_cast(local.i, ^s_node)));
// INV:END
          ...
          anon6:
            ...
            else
            {
              anon4:
                ...
                // struct s_node* j1; 
                // j1 := local.j; 
                SL#j1 := $phys_ptr_cast(local.j, ^s_node);
                // struct s_node* stmtexpr2#8; 
                // stmtexpr2#8 := j1; 
                stmtexpr2#8 := $phys_ptr_cast(SL#j1, ^s_node);
                // assume ==>(@_vcc_ptr_neq_null(local.j), ==(sll_keys(local.j), @_vcc_intset_union(sll_keys(*((local.j->next))), @_vcc_intset_singleton(*((local.j->key)))))); 
                assume $non_null($phys_ptr_cast(local.j, ^s_node)) ==> F#sll_keys($s, $phys_ptr_cast(local.j, ^s_node)) == $intset_union(F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(local.j, ^s_node), ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(local.j, ^s_node))));
                // assume ==>(@_vcc_ptr_neq_null(local.j), ==(sll_list_len_next(local.j), unchecked+(sll_list_len_next(*((local.j->next))), 1))); 
                assume $non_null($phys_ptr_cast(local.j, ^s_node)) ==> F#sll_list_len_next($s, $phys_ptr_cast(local.j, ^s_node)) == $unchk_add(^^nat, F#sll_list_len_next($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(local.j, ^s_node), ^s_node)), 1);
                ...
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, sll_reach(j1)))), ==(old(_dryad_S2, sll_keys(j1)), old(_dryad_S3, sll_keys(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#sll_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#sll_keys(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#sll_keys(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, sll_reach(j1)))), ==(old(_dryad_S2, sll_list_len_next(j1)), old(_dryad_S3, sll_list_len_next(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#sll_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#sll_list_len_next(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#sll_list_len_next(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, rsrtl_reach(j1)))), ==(old(_dryad_S2, rsrtl(j1)), old(_dryad_S3, rsrtl(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#rsrtl_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#rsrtl(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#rsrtl(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, rsrtl_reach(j1)))), ==(old(_dryad_S2, rsrtl_reach(j1)), old(_dryad_S3, rsrtl_reach(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#rsrtl_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#rsrtl_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#rsrtl_reach(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, sll_reach(j1)))), ==(old(_dryad_S2, sll(j1)), old(_dryad_S3, sll(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#sll_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#sll(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#sll(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, sll_reach(j1)))), ==(old(_dryad_S2, sll_reach(j1)), old(_dryad_S3, sll_reach(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#sll_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#sll_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#sll_reach(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, sll_reach(j1)))), ==(old(_dryad_S2, sll_max_key(j1)), old(_dryad_S3, sll_max_key(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#sll_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#sll_max_key(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#sll_max_key(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, sll_reach(j1)))), ==(old(_dryad_S2, sll_min_key(j1)), old(_dryad_S3, sll_min_key(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#sll_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#sll_min_key(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#sll_min_key(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, srtl_reach(j1)))), ==(old(_dryad_S2, srtl(j1)), old(_dryad_S3, srtl(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#srtl_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#srtl(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#srtl(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(unchecked!(@_vcc_oset_in(k, old(_dryad_S2, srtl_reach(j1)))), ==(old(_dryad_S2, srtl_reach(j1)), old(_dryad_S3, srtl_reach(j1)))); 
                assume !$oset_in($phys_ptr_cast(L#k, ^s_node), F#srtl_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node))) ==> F#srtl_reach(SL#_dryad_S2, $phys_ptr_cast(SL#j1, ^s_node)) == F#srtl_reach(SL#_dryad_S3, $phys_ptr_cast(SL#j1, ^s_node));
                ...
                // assume ==>(!(@_vcc_ptr_eq_pure(k, j1)), ==(*((j1->key)), old(_dryad_S2, *((j1->key))))); 
                assume !($phys_ptr_cast(L#k, ^s_node) == $phys_ptr_cast(SL#j1, ^s_node)) ==> $rd_inv($s, s_node.key, $phys_ptr_cast(SL#j1, ^s_node)) == $rd_inv(SL#_dryad_S2, s_node.key, $phys_ptr_cast(SL#j1, ^s_node));
                // assume ==>(!(@_vcc_ptr_eq_pure(k, j1)), @_vcc_ptr_eq_pure(*((j1->next)), old(_dryad_S2, *((j1->next))))); 
                assume !($phys_ptr_cast(L#k, ^s_node) == $phys_ptr_cast(SL#j1, ^s_node)) ==> $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node) == $rd_phys_ptr(SL#_dryad_S2, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node);
                ...
                // assume ==>(@_vcc_ptr_neq_null(j1), ==(sll_keys(j1), @_vcc_intset_union(sll_keys(*((j1->next))), @_vcc_intset_singleton(*((j1->key)))))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) ==> F#sll_keys($s, $phys_ptr_cast(SL#j1, ^s_node)) == $intset_union(F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(SL#j1, ^s_node))));
                // assume ==>(@_vcc_ptr_neq_null(j1), ==(sll_list_len_next(j1), unchecked+(sll_list_len_next(*((j1->next))), 1))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) ==> F#sll_list_len_next($s, $phys_ptr_cast(SL#j1, ^s_node)) == $unchk_add(^^nat, F#sll_list_len_next($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)), 1);
                // assume ==>(&&(@_vcc_ptr_neq_null(j1), @_vcc_ptr_neq_null(*((j1->next)))), ==(rsrtl(j1), &&(&&(rsrtl(*((j1->next))), unchecked!(@_vcc_oset_in(j1, rsrtl_reach(*((j1->next)))))), >=(*((j1->key)), sll_max_key(*((j1->next))))))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) && $non_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)) ==> F#rsrtl($s, $phys_ptr_cast(SL#j1, ^s_node)) == (F#rsrtl($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)) && !$oset_in($phys_ptr_cast(SL#j1, ^s_node), F#rsrtl_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node))) && $rd_inv($s, s_node.key, $phys_ptr_cast(SL#j1, ^s_node)) >= F#sll_max_key($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)));
                // assume ==>(@_vcc_ptr_neq_null(j1), ==(rsrtl_reach(j1), @_vcc_oset_union(rsrtl_reach(*((j1->next))), @_vcc_oset_singleton(j1)))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) ==> F#rsrtl_reach($s, $phys_ptr_cast(SL#j1, ^s_node)) == $oset_union(F#rsrtl_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)), $oset_singleton($phys_ptr_cast(SL#j1, ^s_node)));
                // assume ==>(@_vcc_ptr_neq_null(j1), ==(sll(j1), &&(sll(*((j1->next))), unchecked!(@_vcc_oset_in(j1, sll_reach(*((j1->next)))))))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) ==> F#sll($s, $phys_ptr_cast(SL#j1, ^s_node)) == (F#sll($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)) && !$oset_in($phys_ptr_cast(SL#j1, ^s_node), F#sll_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node))));
                // assume ==>(@_vcc_ptr_neq_null(j1), ==(sll_reach(j1), @_vcc_oset_union(sll_reach(*((j1->next))), @_vcc_oset_singleton(j1)))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) ==> F#sll_reach($s, $phys_ptr_cast(SL#j1, ^s_node)) == $oset_union(F#sll_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)), $oset_singleton($phys_ptr_cast(SL#j1, ^s_node)));
                // assume ==>(&&(@_vcc_ptr_neq_null(j1), @_vcc_ptr_neq_null(*((j1->next)))), ==(sll_max_key(j1), @\int_max(*((j1->key)), sll_max_key(*((j1->next)))))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) && $non_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)) ==> F#sll_max_key($s, $phys_ptr_cast(SL#j1, ^s_node)) == $int_max($rd_inv($s, s_node.key, $phys_ptr_cast(SL#j1, ^s_node)), F#sll_max_key($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)));
                // assume ==>(&&(@_vcc_ptr_neq_null(j1), @_vcc_ptr_neq_null(*((j1->next)))), ==(sll_min_key(j1), @\int_min(*((j1->key)), sll_min_key(*((j1->next)))))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) && $non_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)) ==> F#sll_min_key($s, $phys_ptr_cast(SL#j1, ^s_node)) == $int_min($rd_inv($s, s_node.key, $phys_ptr_cast(SL#j1, ^s_node)), F#sll_min_key($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)));
                // assume ==>(&&(@_vcc_ptr_neq_null(j1), @_vcc_ptr_neq_null(*((j1->next)))), ==(srtl(j1), &&(&&(srtl(*((j1->next))), unchecked!(@_vcc_oset_in(j1, srtl_reach(*((j1->next)))))), <=(*((j1->key)), sll_min_key(*((j1->next))))))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) && $non_null($rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)) ==> F#srtl($s, $phys_ptr_cast(SL#j1, ^s_node)) == (F#srtl($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)) && !$oset_in($phys_ptr_cast(SL#j1, ^s_node), F#srtl_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node))) && $rd_inv($s, s_node.key, $phys_ptr_cast(SL#j1, ^s_node)) <= F#sll_min_key($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)));
                // assume ==>(@_vcc_ptr_neq_null(j1), ==(srtl_reach(j1), @_vcc_oset_union(srtl_reach(*((j1->next))), @_vcc_oset_singleton(j1)))); 
                assume $non_null($phys_ptr_cast(SL#j1, ^s_node)) ==> F#srtl_reach($s, $phys_ptr_cast(SL#j1, ^s_node)) == $oset_union(F#srtl_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#j1, ^s_node), ^s_node)), $oset_singleton($phys_ptr_cast(SL#j1, ^s_node)));
                // assume ==>(@_vcc_ptr_neq_null(h), ==(sll_keys(h), @_vcc_intset_union(sll_keys(*((h->next))), @_vcc_intset_singleton(*((h->key)))))); 
                assume $non_null($phys_ptr_cast(L#h, ^s_node)) ==> F#sll_keys($s, $phys_ptr_cast(L#h, ^s_node)) == $intset_union(F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#h, ^s_node), ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(L#h, ^s_node))));
                // assume ==>(@_vcc_ptr_neq_null(h), ==(sll_list_len_next(h), unchecked+(sll_list_len_next(*((h->next))), 1))); 
                assume $non_null($phys_ptr_cast(L#h, ^s_node)) ==> F#sll_list_len_next($s, $phys_ptr_cast(L#h, ^s_node)) == $unchk_add(^^nat, F#sll_list_len_next($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#h, ^s_node), ^s_node)), 1);
...
axiom (forall Q#__vcc_state$1^687.9#tc2#1654: $state, Q#x$1^687.9#dt1#1619: $ptr :: {:weight 10} { F#srtl(Q#__vcc_state$1^687.9#tc2#1654, $phys_ptr_cast(Q#x$1^687.9#dt1#1619, ^s_node)) } { F#sll(Q#__vcc_state$1^687.9#tc2#1654, $phys_ptr_cast(Q#x$1^687.9#dt1#1619, ^s_node)) } $good_state(Q#__vcc_state$1^687.9#tc2#1654) && true ==> F#srtl(Q#__vcc_state$1^687.9#tc2#1654, $phys_ptr_cast(Q#x$1^687.9#dt1#1619, ^s_node)) ==> F#sll(Q#__vcc_state$1^687.9#tc2#1654, $phys_ptr_cast(Q#x$1^687.9#dt1#1619, ^s_node)));

axiom (forall Q#__vcc_state$1^688.9#tc2#1655: $state, Q#x$1^688.9#dt1#1620: $ptr :: {:weight 10} { F#rsrtl(Q#__vcc_state$1^688.9#tc2#1655, $phys_ptr_cast(Q#x$1^688.9#dt1#1620, ^s_node)) } { F#sll(Q#__vcc_state$1^688.9#tc2#1655, $phys_ptr_cast(Q#x$1^688.9#dt1#1620, ^s_node)) } $good_state(Q#__vcc_state$1^688.9#tc2#1655) && true ==> F#rsrtl(Q#__vcc_state$1^688.9#tc2#1655, $phys_ptr_cast(Q#x$1^688.9#dt1#1620, ^s_node)) ==> F#sll(Q#__vcc_state$1^688.9#tc2#1655, $phys_ptr_cast(Q#x$1^688.9#dt1#1620, ^s_node)));

axiom (forall Q#__vcc_state$1^689.9#tc2#1656: $state, Q#x$1^689.9#dt1#1621: $ptr :: {:weight 10} { F#sll_reach(Q#__vcc_state$1^689.9#tc2#1656, $phys_ptr_cast(Q#x$1^689.9#dt1#1621, ^s_node)) } { F#srtl_reach(Q#__vcc_state$1^689.9#tc2#1656, $phys_ptr_cast(Q#x$1^689.9#dt1#1621, ^s_node)) } $good_state(Q#__vcc_state$1^689.9#tc2#1656) && true ==> F#sll_reach(Q#__vcc_state$1^689.9#tc2#1656, $phys_ptr_cast(Q#x$1^689.9#dt1#1621, ^s_node)) == F#srtl_reach(Q#__vcc_state$1^689.9#tc2#1656, $phys_ptr_cast(Q#x$1^689.9#dt1#1621, ^s_node)));

axiom (forall Q#__vcc_state$1^690.9#tc2#1657: $state, Q#x$1^690.9#dt1#1622: $ptr :: {:weight 10} { F#srtl_reach(Q#__vcc_state$1^690.9#tc2#1657, $phys_ptr_cast(Q#x$1^690.9#dt1#1622, ^s_node)) } { F#rsrtl_reach(Q#__vcc_state$1^690.9#tc2#1657, $phys_ptr_cast(Q#x$1^690.9#dt1#1622, ^s_node)) } $good_state(Q#__vcc_state$1^690.9#tc2#1657) && true ==> F#srtl_reach(Q#__vcc_state$1^690.9#tc2#1657, $phys_ptr_cast(Q#x$1^690.9#dt1#1622, ^s_node)) == F#rsrtl_reach(Q#__vcc_state$1^690.9#tc2#1657, $phys_ptr_cast(Q#x$1^690.9#dt1#1622, ^s_node)));

axiom (forall Q#__vcc_state$1^691.9#tc2#1658: $state, Q#x$1^691.9#dt1#1623: $ptr, Q#y$1^691.9#dt1#1624: $ptr :: {:weight 10} { F#sll_lseg_reach(Q#__vcc_state$1^691.9#tc2#1658, $phys_ptr_cast(Q#x$1^691.9#dt1#1623, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1624, ^s_node)) } { F#srtl_lseg_reach(Q#__vcc_state$1^691.9#tc2#1658, $phys_ptr_cast(Q#x$1^691.9#dt1#1623, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1624, ^s_node)) } $good_state(Q#__vcc_state$1^691.9#tc2#1658) && true ==> F#sll_lseg_reach(Q#__vcc_state$1^691.9#tc2#1658, $phys_ptr_cast(Q#x$1^691.9#dt1#1623, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1624, ^s_node)) == F#srtl_lseg_reach(Q#__vcc_state$1^691.9#tc2#1658, $phys_ptr_cast(Q#x$1^691.9#dt1#1623, ^s_node), $phys_ptr_cast(Q#y$1^691.9#dt1#1624, ^s_node)));
