  ...
  anon10:
    ...
    if ($non_null($phys_ptr_cast(L#i, ^s_node)))
    {
      anon7:
        ...
        // stmtexpr0#8 := i0; 
        stmtexpr0#8 := $phys_ptr_cast(SL#i0, ^s_node);
        // assume ==>(@_vcc_ptr_neq_null(i), ==(sll_keys(i), @_vcc_intset_union(sll_keys(*((i->next))), @_vcc_intset_singleton(*((i->key)))))); 
        assume $non_null($phys_ptr_cast(L#i, ^s_node)) ==> F#sll_keys($s, $phys_ptr_cast(L#i, ^s_node)) == $intset_union(F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#i, ^s_node), ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(L#i, ^s_node))));
        // assume ==>(@_vcc_ptr_neq_null(i), ==(sll(i), &&(sll(*((i->next))), unchecked!(@_vcc_oset_in(i, sll_reach(*((i->next)))))))); 
        assume $non_null($phys_ptr_cast(L#i, ^s_node)) ==> F#sll($s, $phys_ptr_cast(L#i, ^s_node)) == (F#sll($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#i, ^s_node), ^s_node)) && !$oset_in($phys_ptr_cast(L#i, ^s_node), F#sll_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#i, ^s_node), ^s_node))));
...
invariant b0009 ==> (((F#sll($s,$phys_ptr_cast(P#h,^s_node)) && F#sll($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0010 ==> (((F#sll($s,$phys_ptr_cast(P#h,^s_node)) && F#sll($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0011 ==> (((F#sll($s,$phys_ptr_cast(L#i,^s_node)) && F#sll($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0012 ==> (((F#sll($s,$phys_ptr_cast(L#i,^s_node)) && F#sll($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0013 ==> (((F#sll($s,$phys_ptr_cast(L#j,^s_node)) && F#sll($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0014 ==> (((F#sll($s,$phys_ptr_cast(L#j,^s_node)) && F#sll($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0015 ==> (((F#sll_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#sll($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0016 ==> (((F#sll_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#sll($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0017 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#sll($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0018 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#sll($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0019 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#sll($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0020 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#sll($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0021 ==> (((F#sll_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#sll($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0022 ==> (((F#sll_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#sll($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0023 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#sll($s,$phys_ptr_cast(L#j,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0024 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) && F#sll($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0025 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) && F#sll($s,$phys_ptr_cast(L#i,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0026 ==> (((F#sll_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) && F#sll($s,$phys_ptr_cast(P#h,^s_node))) ==> $oset_disjoint(F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0027 ==> ((F#sll($s,$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0028 ==> ((F#sll($s,$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0029 ==> ((F#sll($s,$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0030 ==> ((F#sll($s,$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#j,^s_node)))));
invariant b0031 ==> ((F#sll($s,$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#h,^s_node)))));
invariant b0032 ==> ((F#sll($s,$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_reach($s,$phys_ptr_cast(L#i,^s_node)))));
invariant b0033 ==> ((F#sll_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0034 ==> ((F#sll_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#h,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0035 ==> ((F#sll_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#j,^s_node)))));
invariant b0036 ==> ((F#sll_lseg($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#i,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#j,^s_node),$phys_ptr_cast(P#h,^s_node)))));
invariant b0037 ==> ((F#sll_lseg($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(P#h,^s_node),$phys_ptr_cast(L#i,^s_node)))));
invariant b0038 ==> ((F#sll_lseg($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(L#j,^s_node)),F#sll_lseg_reach($s,$phys_ptr_cast(L#i,^s_node),$phys_ptr_cast(P#h,^s_node)))));
...
invariant b0062 ==> (($non_null($phys_ptr_cast(L#j,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(L#j,^s_node),^s_node) == $phys_ptr_cast(L#i,^s_node))));
          ...
          invariant $non_null($phys_ptr_cast(L#i, ^s_node)) ==> $top_writable($s, #wrTime$2^7.3, $phys_ptr_cast(L#i, ^s_node));
        {
          anon6:
            ...
            assume $full_stop_ext(#tok$2^22.7, $s);
            ...
            if ($non_null($phys_ptr_cast(L#i, ^s_node)))
            {
              anon3:
                ...
                assume $full_stop_ext(#tok$2^36.13, $s);
                ...
                if (ite#1)
                {
                  anon1:
                    ...
                    assume $full_stop_ext(#tok$2^38.11, $s);
                    ...
                    // assume ==>(unchecked!(@_vcc_oset_in(j, old(_dryad_S0, sll_reach(i1)))), ==(old(_dryad_S0, sll_keys(i1)), old(_dryad_S1, sll_keys(i1)))); 
                    assume !$oset_in($phys_ptr_cast(L#j, ^s_node), F#sll_reach(SL#_dryad_S0, $phys_ptr_cast(SL#i1, ^s_node))) ==> F#sll_keys(SL#_dryad_S0, $phys_ptr_cast(SL#i1, ^s_node)) == F#sll_keys(SL#_dryad_S1, $phys_ptr_cast(SL#i1, ^s_node));
                    // assume ==>(unchecked!(@_vcc_oset_in(j, old(_dryad_S0, sll_reach(i1)))), ==(old(_dryad_S0, sll(i1)), old(_dryad_S1, sll(i1)))); 
                    assume !$oset_in($phys_ptr_cast(L#j, ^s_node), F#sll_reach(SL#_dryad_S0, $phys_ptr_cast(SL#i1, ^s_node))) ==> F#sll(SL#_dryad_S0, $phys_ptr_cast(SL#i1, ^s_node)) == F#sll(SL#_dryad_S1, $phys_ptr_cast(SL#i1, ^s_node));
                    // assume ==>(unchecked!(@_vcc_oset_in(j, old(_dryad_S0, sll_reach(i1)))), ==(old(_dryad_S0, sll_reach(i1)), old(_dryad_S1, sll_reach(i1)))); 
                    assume !$oset_in($phys_ptr_cast(L#j, ^s_node), F#sll_reach(SL#_dryad_S0, $phys_ptr_cast(SL#i1, ^s_node))) ==> F#sll_reach(SL#_dryad_S0, $phys_ptr_cast(SL#i1, ^s_node)) == F#sll_reach(SL#_dryad_S1, $phys_ptr_cast(SL#i1, ^s_node));
                    ...
                    // assume ==>(unchecked!(@_vcc_oset_in(j, old(_dryad_S0, sll_lseg_reach(h, i)))), ==(old(_dryad_S0, sll_lseg_keys(h, i)), old(_dryad_S1, sll_lseg_keys(h, i)))); 
                    assume !$oset_in($phys_ptr_cast(L#j, ^s_node), F#sll_lseg_reach(SL#_dryad_S0, $phys_ptr_cast(P#h, ^s_node), $phys_ptr_cast(L#i, ^s_node))) ==> F#sll_lseg_keys(SL#_dryad_S0, $phys_ptr_cast(P#h, ^s_node), $phys_ptr_cast(L#i, ^s_node)) == F#sll_lseg_keys(SL#_dryad_S1, $phys_ptr_cast(P#h, ^s_node), $phys_ptr_cast(L#i, ^s_node));
                    // assume ==>(!(@_vcc_ptr_eq_pure(j, i1)), ==(*((i1->key)), old(_dryad_S0, *((i1->key))))); 
                    assume !($phys_ptr_cast(L#j, ^s_node) == $phys_ptr_cast(SL#i1, ^s_node)) ==> $rd_inv($s, s_node.key, $phys_ptr_cast(SL#i1, ^s_node)) == $rd_inv(SL#_dryad_S0, s_node.key, $phys_ptr_cast(SL#i1, ^s_node));
                    // assume ==>(!(@_vcc_ptr_eq_pure(j, i1)), @_vcc_ptr_eq_pure(*((i1->next)), old(_dryad_S0, *((i1->next))))); 
                    assume !($phys_ptr_cast(L#j, ^s_node) == $phys_ptr_cast(SL#i1, ^s_node)) ==> $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#i1, ^s_node), ^s_node) == $rd_phys_ptr(SL#_dryad_S0, s_node.next, $phys_ptr_cast(SL#i1, ^s_node), ^s_node);
                    ...
                    // assume ==>(@_vcc_ptr_neq_null(i1), ==(sll_keys(i1), @_vcc_intset_union(sll_keys(*((i1->next))), @_vcc_intset_singleton(*((i1->key)))))); 
                    assume $non_null($phys_ptr_cast(SL#i1, ^s_node)) ==> F#sll_keys($s, $phys_ptr_cast(SL#i1, ^s_node)) == $intset_union(F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#i1, ^s_node), ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(SL#i1, ^s_node))));
                    // assume ==>(@_vcc_ptr_neq_null(i1), ==(sll(i1), &&(sll(*((i1->next))), unchecked!(@_vcc_oset_in(i1, sll_reach(*((i1->next)))))))); 
                    assume $non_null($phys_ptr_cast(SL#i1, ^s_node)) ==> F#sll($s, $phys_ptr_cast(SL#i1, ^s_node)) == (F#sll($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#i1, ^s_node), ^s_node)) && !$oset_in($phys_ptr_cast(SL#i1, ^s_node), F#sll_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#i1, ^s_node), ^s_node))));
                    // assume ==>(@_vcc_ptr_neq_null(i1), ==(sll_reach(i1), @_vcc_oset_union_one2(sll_reach(*((i1->next))), i1))); 
                    assume $non_null($phys_ptr_cast(SL#i1, ^s_node)) ==> F#sll_reach($s, $phys_ptr_cast(SL#i1, ^s_node)) == $oset_union_one2(F#sll_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(SL#i1, ^s_node), ^s_node)), $phys_ptr_cast(SL#i1, ^s_node));
                    // assume ==>(@_vcc_ptr_neq_null(inxt), ==(sll_keys(inxt), @_vcc_intset_union(sll_keys(*((inxt->next))), @_vcc_intset_singleton(*((inxt->key)))))); 
                    assume $non_null($phys_ptr_cast(L#inxt, ^s_node)) ==> F#sll_keys($s, $phys_ptr_cast(L#inxt, ^s_node)) == $intset_union(F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#inxt, ^s_node), ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(L#inxt, ^s_node))));
                    // assume ==>(@_vcc_ptr_neq_null(inxt), ==(sll(inxt), &&(sll(*((inxt->next))), unchecked!(@_vcc_oset_in(inxt, sll_reach(*((inxt->next)))))))); 
                    assume $non_null($phys_ptr_cast(L#inxt, ^s_node)) ==> F#sll($s, $phys_ptr_cast(L#inxt, ^s_node)) == (F#sll($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#inxt, ^s_node), ^s_node)) && !$oset_in($phys_ptr_cast(L#inxt, ^s_node), F#sll_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#inxt, ^s_node), ^s_node))));
              ...
              anon4:
                // struct s_node* i1#0; 
                // i1#0 := i; 
                i1#0 := $phys_ptr_cast(L#i, ^s_node);
                // struct s_node* stmtexpr0#7; 
                // stmtexpr0#7 := i1#0; 
                stmtexpr0#7 := $phys_ptr_cast(i1#0, ^s_node);
                // assume ==>(@_vcc_ptr_neq_null(i), ==(sll_keys(i), @_vcc_intset_union(sll_keys(*((i->next))), @_vcc_intset_singleton(*((i->key)))))); 
                assume $non_null($phys_ptr_cast(L#i, ^s_node)) ==> F#sll_keys($s, $phys_ptr_cast(L#i, ^s_node)) == $intset_union(F#sll_keys($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#i, ^s_node), ^s_node)), $intset_singleton($rd_inv($s, s_node.key, $phys_ptr_cast(L#i, ^s_node))));
                // assume ==>(@_vcc_ptr_neq_null(i), ==(sll(i), &&(sll(*((i->next))), unchecked!(@_vcc_oset_in(i, sll_reach(*((i->next)))))))); 
                assume $non_null($phys_ptr_cast(L#i, ^s_node)) ==> F#sll($s, $phys_ptr_cast(L#i, ^s_node)) == (F#sll($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#i, ^s_node), ^s_node)) && !$oset_in($phys_ptr_cast(L#i, ^s_node), F#sll_reach($s, $rd_phys_ptr($s, s_node.next, $phys_ptr_cast(L#i, ^s_node), ^s_node))));
...
const unique #tok$2^38.11: $token;

const unique #tok$2^36.13: $token;

const unique #tok$2^22.7: $token;
...
const unique #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cafwp?5CSLL?2Dfilter.c: $token;

axiom $file_name_is(2, #file^Z?3A?5CInvariantSynthesis?5CVCDryad?5Cvcc?5CHost?5Cbin?5CTests?5Cafwp?5CSLL?2Dfilter.c);

const unique #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Cafwp?5Cdryad_SLL.h: $token;

axiom $file_name_is(1, #file^z?3A?5Cinvariantsynthesis?5Cvcdryad?5Cvcc?5Chost?5Cbin?5Ctests?5Cafwp?5Cdryad_SLL.h);
