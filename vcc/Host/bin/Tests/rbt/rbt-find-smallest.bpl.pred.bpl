...
ensures b0000 ==> (F#rbt($s,$phys_ptr_cast(P#x,^r_node)));
ensures b0001 ==> ((F#rbt_reach($s,$phys_ptr_cast(P#x,^r_node)) == F#rbt_reach(old($s),$phys_ptr_cast(P#x,^r_node))));
ensures b0002 ==> ($non_null($phys_ptr_cast(P#x,^r_node)));
ensures b0003 ==> ($is_null($phys_ptr_cast(P#x,^r_node)));
ensures b0004 ==> (($non_null($phys_ptr_cast(P#x,^r_node)) ==> $non_null($rd_phys_ptr($s,r_node.left,$phys_ptr_cast(P#x,^r_node),^r_node))));
ensures b0005 ==> (($non_null($phys_ptr_cast(P#x,^r_node)) ==> $is_null($rd_phys_ptr($s,r_node.left,$phys_ptr_cast(P#x,^r_node),^r_node))));
ensures b0006 ==> (($non_null($phys_ptr_cast(P#x,^r_node)) ==> $non_null($rd_phys_ptr($s,r_node.right,$phys_ptr_cast(P#x,^r_node),^r_node))));
ensures b0007 ==> (($non_null($phys_ptr_cast(P#x,^r_node)) ==> $is_null($rd_phys_ptr($s,r_node.right,$phys_ptr_cast(P#x,^r_node),^r_node))));
ensures b0008 ==> ((F#rbt_keys($s,$phys_ptr_cast(P#x,^r_node)) == F#rbt_keys(old($s),$phys_ptr_cast(P#x,^r_node))));
ensures b0009 ==> ((F#rbt_keys($s,$phys_ptr_cast(P#x,^r_node)) == $intset_union(F#rbt_keys(old($s),$phys_ptr_cast(P#x,^r_node)),$intset_singleton($result))));
ensures b0010 ==> ((F#rbt_keys(old($s),$phys_ptr_cast(P#x,^r_node)) == $intset_union(F#rbt_keys($s,$phys_ptr_cast(P#x,^r_node)),$intset_singleton($result))));
ensures b0011 ==> (($result < 2147483647));
ensures b0012 ==> (($result < 4294967295));
ensures b0013 ==> (($result >= 0));
ensures b0014 ==> (($rd_inv($s,r_node.key,$phys_ptr_cast(P#x,^r_node)) < $result));
