  ...
  _(ensures \oset_disjoint(srtl_reach(\result), srtl_reach(x)))
{
  ...
  while(curr_x->next != NULL && curr_y->next != NULL)
    ...
    _(invariant \oset_disjoint(srtl_reach(x), srtl_lseg_reach(x, curr_x)))

    _(invariant srtl(z))
    _(invariant srtl(last_z))
    _(invariant srtl_lseg(z, last_z))
    _(invariant \oset_disjoint(srtl_reach(z), srtl_lseg_reach(z, last_z)))

    _(invariant srtl(y))
    _(invariant srtl(curr_y))
    _(invariant srtl_lseg(y, curr_y))
    _(invariant \oset_disjoint(srtl_reach(y), srtl_lseg_reach(y, curr_y)))
