...
procedure sll_insert(P#x: $ptr, P#k: int) returns ($result: $ptr);
  ...
  modifies $s, $cev_pc;
ensures b0000 ==> (F#sll($s,$phys_ptr_cast(P#x,^s_node)));
ensures b0001 ==> (F#sll($s,$phys_ptr_cast($result,^s_node)));
ensures b0002 ==> (((F#sll($s,$phys_ptr_cast(P#x,^s_node)) && F#sll($s,$phys_ptr_cast($result,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast(P#x,^s_node)),F#sll_reach($s,$phys_ptr_cast($result,^s_node)))));
ensures b0003 ==> (((F#sll($s,$phys_ptr_cast($result,^s_node)) && F#sll($s,$phys_ptr_cast(P#x,^s_node))) ==> $oset_disjoint(F#sll_reach($s,$phys_ptr_cast($result,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#x,^s_node)))));
ensures b0004 ==> ((F#sll($s,$phys_ptr_cast($result,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast(P#x,^s_node)),F#sll_reach($s,$phys_ptr_cast($result,^s_node)))));
ensures b0005 ==> ((F#sll($s,$phys_ptr_cast(P#x,^s_node)) ==> $oset_disjoint($oset_singleton($phys_ptr_cast($result,^s_node)),F#sll_reach($s,$phys_ptr_cast(P#x,^s_node)))));
ensures b0006 ==> ($non_null($phys_ptr_cast(P#x,^s_node)));
ensures b0007 ==> ($non_null($phys_ptr_cast($result,^s_node)));
ensures b0008 ==> ($is_null($phys_ptr_cast(P#x,^s_node)));
ensures b0009 ==> ($is_null($phys_ptr_cast($result,^s_node)));
ensures b0010 ==> (($phys_ptr_cast(P#x,^s_node) == $phys_ptr_cast($result,^s_node)));
ensures b0011 ==> (($phys_ptr_cast($result,^s_node) == $phys_ptr_cast(P#x,^s_node)));
ensures b0012 ==> (($non_null($phys_ptr_cast(P#x,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#x,^s_node),^s_node))));
ensures b0013 ==> (($non_null($phys_ptr_cast($result,^s_node)) ==> $non_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast($result,^s_node),^s_node))));
ensures b0014 ==> (($non_null($phys_ptr_cast(P#x,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#x,^s_node),^s_node))));
ensures b0015 ==> (($non_null($phys_ptr_cast($result,^s_node)) ==> $is_null($rd_phys_ptr($s,s_node.next,$phys_ptr_cast($result,^s_node),^s_node))));
ensures b0016 ==> (($non_null($phys_ptr_cast(P#x,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast(P#x,^s_node),^s_node) == $phys_ptr_cast($result,^s_node))));
ensures b0017 ==> (($non_null($phys_ptr_cast($result,^s_node)) ==> ($rd_phys_ptr($s,s_node.next,$phys_ptr_cast($result,^s_node),^s_node) == $phys_ptr_cast(P#x,^s_node))));
ensures b0018 ==> ((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))))));
ensures b0019 ==> ((!($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast($result,^s_node))))));
ensures b0020 ==> ($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
ensures b0021 ==> ($intset_in(P#k,F#sll_keys($s,$phys_ptr_cast($result,^s_node))));
ensures b0022 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == F#sll_keys($s,$phys_ptr_cast($result,^s_node))));
ensures b0023 ==> ((F#sll_keys($s,$phys_ptr_cast($result,^s_node)) == F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
ensures b0024 ==> ((F#sll_keys(old($s),$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast($result,^s_node)))));
ensures b0025 ==> ((F#sll_keys(old($s),$phys_ptr_cast($result,^s_node)) == $intset_union(F#sll_keys($s,$phys_ptr_cast($result,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
ensures b0026 ==> ((F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)) == $intset_union(F#sll_keys(old($s),$phys_ptr_cast(P#x,^s_node)),F#sll_keys($s,$phys_ptr_cast($result,^s_node)))));
ensures b0027 ==> ((F#sll_keys($s,$phys_ptr_cast($result,^s_node)) == $intset_union(F#sll_keys(old($s),$phys_ptr_cast($result,^s_node)),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)))));
ensures b0028 ==> ((P#k < 2147483647));
ensures b0029 ==> ((P#k < 2147483647));
ensures b0030 ==> ((P#k < 4294967295));
ensures b0031 ==> ((P#k < 4294967295));
ensures b0032 ==> ((P#k >= 0));
ensures b0033 ==> ((P#k >= 0));
ensures b0034 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) < P#k));
ensures b0035 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast($result,^s_node)) < P#k));
ensures b0036 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast($result,^s_node))));
ensures b0037 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast($result,^s_node)) <= $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node))));
ensures b0038 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast($result,^s_node))));
ensures b0039 ==> (($rd_inv($s,s_node.key,$phys_ptr_cast($result,^s_node)) == $rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node))));
ensures b0040 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),$intset_singleton(P#k)));
ensures b0041 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast($result,^s_node)),$intset_singleton(P#k)));
ensures b0042 ==> ($intset_le($intset_singleton(P#k),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
ensures b0043 ==> ($intset_le($intset_singleton(P#k),F#sll_keys($s,$phys_ptr_cast($result,^s_node))));
ensures b0044 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast($result,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node)))));
ensures b0045 ==> ($intset_le(F#sll_keys($s,$phys_ptr_cast(P#x,^s_node)),$intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast($result,^s_node)))));
ensures b0046 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast(P#x,^s_node))),F#sll_keys($s,$phys_ptr_cast(P#x,^s_node))));
ensures b0047 ==> ($intset_le($intset_singleton($rd_inv($s,s_node.key,$phys_ptr_cast($result,^s_node))),F#sll_keys($s,$phys_ptr_cast($result,^s_node))));
