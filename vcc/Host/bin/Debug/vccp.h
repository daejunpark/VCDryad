...
// added for dryad
_(const char * const \declspec_dryad)
...
// intset definitions
_(\intset _(_boogie0) \intset_empty() ;)
_(\intset _(_boogie0) \intset_universe() ;)
_(\intset _(_boogie0) \intset_singleton(int el))
_(\intset _(_boogie0) \intset_union(\intset is1, \intset is2))
_(\intset _(_boogie0) \intset_union_one1(int el, \intset is2))
_(\intset _(_boogie0) \intset_union_one2(\intset is2, int el))
_(\intset _(_boogie0) \intset_intersect(\intset is1, \intset is2))
_(\intset _(_boogie0) \intset_diff(\intset is1, \intset is2))
_(\bool   _(_boogie0) \intset_in(int el, \intset is)) 
_(\bool   _(_boogie0) \intset_eq(\intset is1, \intset is2))
_(\bool   _(_boogie0) \intset_disjoint(\intset is1, \intset is2))
_(\bool   _(_boogie0) \intset_subset(\intset is1, \intset is2))
_(\bool   _(_boogie0) \intset_lt_one1(int el, \intset is2))
_(\bool   _(_boogie0) \intset_lt_one2(\intset is2, int el))
_(\bool   _(_boogie0) \intset_lt(\intset is1, \intset is2))
_(\bool   _(_boogie0) \intset_le_one1(int el, \intset is2))
_(\bool   _(_boogie0) \intset_le_one2(\intset is2, int el))
_(\bool   _(_boogie0) \intset_le(\intset is1, \intset is2))

// oset definitions
_(\oset _(_boogie0) \oset_empty())
_(\oset _(_boogie0) \oset_universe())
_(\oset _(_boogie0) \oset_singleton(\object el))
_(\oset _(_boogie0) \oset_union(\oset os1, \oset os2))
_(\oset _(_boogie0) \oset_union_one1(\object el, \oset os2))
_(\oset _(_boogie0) \oset_union_one2(\oset os2, \object el))
_(\oset _(_boogie0) \oset_intersect(\oset os1, \oset os2))
_(\oset _(_boogie0) \oset_diff(\oset os1, \oset os2))
_(\bool _(_boogie0) \oset_in(\object el, \oset os))
_(\bool _(_boogie0) \oset_eq(\oset os1, \oset os2))
_(\bool _(_boogie0) \oset_disjoint(\oset os1, \oset os2))
_(\bool _(_boogie0) \oset_subset(\oset os1, \oset os2))

_(pure \oset _(dryad) glob_reach() ;)
//_(pure \oset _(dryad) G_post() ;)

// dryad pre, post, inv
_(\bool \dryad_pre(char *) ;)
_(\bool \dryad_post(char *) ;)
_(\bool \dryad_inv(char *) ;)
