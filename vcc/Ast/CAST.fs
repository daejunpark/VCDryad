...
module Microsoft.Research.Vcc.CAST
  ...
  type [<StructuralEquality; NoComparison>] CustomAttr =
    ...
    override this.ToString () =
      match this with
        | IntBoogieAttr (s, i) -> sprintf "_IB(%s %d)" s i
  ...
  and [<StructuralEquality; NoComparison>] Type =
    ...
    // +++++ is* members checking type mebership +++++
    ...
    member this.IsOSet = this.IsMathType "\\oset"
    member this.IsIntSet = this.IsMathType "\\intset"
    ...
    static member IntSet = Type.Math "\\intset"
    static member OSet = Type.Math "\\oset"
  ...
  and [<CustomEquality; CustomComparison>]
    Variable = 
      ...
      override this.ToString () = toString (this.WriteTo)
  // ===== end of Variable type definition =====
 ...
 // --------------------------------------------------------------------------
  ...
  // ===== end of Function type definition =====
  ...
  and Expr =
    ...
    | Deref of ExprCommon * Expr         // ExprCommon should have the type of the expression it represents
