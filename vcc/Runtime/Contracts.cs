...
namespace System.Diagnostics.Contracts
{
  ...
  public static partial class CodeContract
  {
    ...
    public abstract class Intset
    {
        // ensure the size is non-zero
        byte dummy;
        private Intset() { dummy++; }

        public static bool operator <=(TypedPtr elem, Intset set)
        {
            throw new NotImplementedException();
        }
        ...
        public static Intset operator |(Intset s1, Intset s2)
        {
            throw new NotImplementedException();
        }
        ...
        public static Intset operator -(Intset s, TypedPtr o)
        {
            throw new NotImplementedException();
        }
    ...
    public abstract class Oset
    {
        // ensure the size is non-zero
        byte dummy;
        private Oset() { dummy++; }

        public static bool operator <=(TypedPtr elem, Oset set)
        {
            throw new NotImplementedException();
        }
        ...
        public static Oset operator |(Oset s1, Oset s2)
        {
            throw new NotImplementedException();
        }
        ...
        public static Oset operator -(Oset s, TypedPtr o)
        {
            throw new NotImplementedException();
        }
